...
export const projects: Project[] = [
...
},
  {
    ...
    fullDescription: `
      The existing website of SG U.N.S. Rheinhessen was outdated and hard to maintain.
      I redesigned and rebuilt it from scratch with a focus on clarity, accessibility, 
      and long-term maintainability.

      The new site is built with Next.js 16 and Payload CMS 3, giving selected club members
      a fully managed admin panel to update news, teams, and sponsor information
      without touching code. Media is stored via Vercel Blob, and the database
      runs on Neon (Postgres) hosted in Frankfurt.

      The contact form uses Nodemailer with a Netcup SMTP relay. Analytics are
      implemented via Vercel Analytics — cookieless and GDPR-compliant by default.
    `,
